    ...
    public function store(Request $request)
    {
        ...
        if ($request->has('soal_list')) {
            $validated = $request->validate([
                ...
                'soal_list.*.tipe_soal' => 'required|in:uraian,pilihan_ganda,pilihan_ganda_multi,uraian_multi',
        ...
        $validated = $request->validate([
            ...
            'tipe_soal' => 'required|in:uraian,pilihan_ganda,pilihan_ganda_multi,uraian_multi',
